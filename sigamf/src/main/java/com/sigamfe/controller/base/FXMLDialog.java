...
public class FXMLDialog extends Stage implements Serializable {
	...
	public FXMLDialog(BaseController controller, Window owner) {
		this(controller, owner, null, null);
	}

	public FXMLDialog(BaseController controller, Window owner, Modality modality) {
		this(controller, owner, modality, null);
	}

	public FXMLDialog(BaseController controller, Window owner, Modality modality, StageStyle style) {
		super();
